...
export async function runActions(actions, onCommand, channel, allowVoice = false) {
  ...
  for (let round = 0; round < MAX_ROUNDS; round++) {
    ...
    const PDF_CHAIN = new Set(['pdfEditText', 'pdfRestyle', 'pdfInsert', 'pdfDelete', 'pdfMove', 'pdfAlign', 'pdfReorder', 'pdfRestack', 'pdfShape', 'pdfStyleShape', 'createVariable', 'pdfSetVariable', 'pdfSave'])
