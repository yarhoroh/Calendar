...
const api = {
  ...
  setGeminiModel: (model) => ipcRenderer.invoke('gemini:set-model', model),
  testGemini: () => ipcRenderer.invoke('gemini:test'),
  // Anthropic API (paid, cost-measured) + usage report
  getAnthropicStatus: () => ipcRenderer.invoke('anthropic:status'),
  setAnthropicKey: (key) => ipcRenderer.invoke('anthropic:set-key', key),
  setAnthropicModel: (model) => ipcRenderer.invoke('anthropic:set-model', model),
